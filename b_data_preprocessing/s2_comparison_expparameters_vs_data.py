...
def s2_comparison_expparameters_vs_data():
    ...
    for exp in range(2):  # 0=rotation, 1=translation
        ...
        fig.write_image("corr_axis_out_exp_%s.png" % (varr['which_exp']))
        ...
        fig.show(config=config)
        # fig.write_image("corr_speed_stim_out_exp_%s.png" % (varr['which_exp']))
