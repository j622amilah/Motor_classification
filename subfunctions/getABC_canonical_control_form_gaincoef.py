...
from subfunctions.pole_placement import *
from subfunctions.choose_best_regression_metric import *

# Calculate regression metrics
from sklearn.metrics import r2_score
from subfunctions.rsquared_abserror import *

from subfunctions.plot_best_coefmeth import *



def getABC_canonical_control_form_gaincoef(way_coeff, mapping_coefs, inputs_generic, outputs_generic, time, n, ts, metric_type, plot_ALL_predictions, gainORnot):
    ...
    if n == 2:
        ...
        if gainORnot == 0:
            ...
            # It is unclear what value to multiply by the coefficients, but from trial-and-error, a larger value than the height of the input and output is required.
