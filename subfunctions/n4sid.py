...
from subfunctions.getABC_canonical_control_form_gaintf import *
from subfunctions.getABC_canonical_control_form_gaincoef import *
from subfunctions.hankel_construction import *
...
def n4sid(inputs_org, inputs_norm, outputs_org, outputs_norm, time, n, ts, way_coeff, normy0Rnot, meth, metric_type, plot_ALL_predictions, plot_coef, where2regulate_gain, gainORnot):
    ...
    # What type of model do you want?  0) Discrete, 1) Continuous, or 2) choose the best fit
    mod_desire = 0 
