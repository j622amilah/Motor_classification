...
#include "c19_Sim_Forcing_003h_expe_infra5_full_control5.h"
...
static SFc19_Sim_Forcing_003h_expe_infra5_full_control5InstanceStruct
  chartInstance;

/* Function Declarations */
static void initialize_c19_Sim_Forcing_003h_expe_infra5_full_control5(void);
static void initialize_params_c19_Sim_Forcing_003h_expe_infra5_full_control5
  (void);
static void enable_c19_Sim_Forcing_003h_expe_infra5_full_control5(void);
static void disable_c19_Sim_Forcing_003h_expe_infra5_full_control5(void);
static void c19_update_debugger_state_c19_Sim_Forcing_003h_expe_infra5_full(void);
static void ext_mode_exec_c19_Sim_Forcing_003h_expe_infra5_full_control5(void);
static const mxArray
  *get_sim_state_c19_Sim_Forcing_003h_expe_infra5_full_control5(void);
static void set_sim_state_c19_Sim_Forcing_003h_expe_infra5_full_control5(const
  mxArray *c19_st);
static void finalize_c19_Sim_Forcing_003h_expe_infra5_full_control5(void);
static void sf_c19_Sim_Forcing_003h_expe_infra5_full_control5(void);
...
static void initialize_c19_Sim_Forcing_003h_expe_infra5_full_control5(void)
{
  uint8_T *c19_is_active_c19_Sim_Forcing_003h_expe_infra5_full_control5;
  c19_is_active_c19_Sim_Forcing_003h_expe_infra5_full_control5 = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c19_is_active_c19_Sim_Forcing_003h_expe_infra5_full_control5 = 0U;
}
...
static void ext_mode_exec_c19_Sim_Forcing_003h_expe_infra5_full_control5(void)
{
  c19_update_debugger_state_c19_Sim_Forcing_003h_expe_infra5_full();
}
  ...
  *get_sim_state_c19_Sim_Forcing_003h_expe_infra5_full_control5(void)
{
  ...
  c19_f_u = *c19_is_active_c19_Sim_Forcing_003h_expe_infra5_full_control5;
  c19_g_y = NULL;
  ...
  mxArray *c19_st)
{
  ...
  real_T c19_d2;
  real_T c19_e_y;
  const mxArray *c19_is_active_c19_Sim_Forcing_003h_expe_infra5_full_control5;
  uint8_T c19_u0;
  uint8_T c19_f_y;
  ...
  real_T *c19_flag_out;
  real_T *c19_vis_cond;
  uint8_T *c19_b_is_active_c19_Sim_Forcing_003h_expe_infra5_full_control5;
  real_T (*c19_c_mask)[3];
  real_T (*c19_target_ang_speed)[3];
  c19_d_endOffile_out = (real_T *)ssGetOutputPortSignal(chartInstance.S, 5);
  c19_b_is_active_c19_Sim_Forcing_003h_expe_infra5_full_control5 = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  c19_vis_cond = (real_T *)ssGetOutputPortSignal(chartInstance.S, 3);
  c19_target_ang_speed = (real_T (*)[3])ssGetOutputPortSignal(chartInstance.S, 1);
  ...
  *c19_vis_cond = c19_e_y;
  c19_is_active_c19_Sim_Forcing_003h_expe_infra5_full_control5 = sf_mex_dup
    (sf_mex_getcell(c19_u, 5));
  sf_mex_import("is_active_c19_Sim_Forcing_003h_expe_infra5_full_control5",
                sf_mex_dup(
    c19_is_active_c19_Sim_Forcing_003h_expe_infra5_full_control5), &c19_u0, 1, 3,
                0U, 0, 0U, 0);
  c19_f_y = c19_u0;
  sf_mex_destroy(&c19_is_active_c19_Sim_Forcing_003h_expe_infra5_full_control5);
  *c19_b_is_active_c19_Sim_Forcing_003h_expe_infra5_full_control5 = c19_f_y;
...
const mxArray
  *sf_c19_Sim_Forcing_003h_expe_infra5_full_control5_get_eml_resolved_functions_info
  (void)
{
...
/* SFunction Glue Code */
void sf_c19_Sim_Forcing_003h_expe_infra5_full_control5_get_check_sum(mxArray
  *plhs[])
{
...
mxArray
  *sf_c19_Sim_Forcing_003h_expe_infra5_full_control5_get_autoinheritance_info
  (void)
{
...
static mxArray
  *sf_get_sim_state_info_c19_Sim_Forcing_003h_expe_infra5_full_control5(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[18],T\"endOffile_out\",},{M[1],M[17],T\"flag_out\",},{M[1],M[15],T\"mask\",},{M[1],M[5],T\"target_ang_speed\",},{M[1],M[16],T\"vis_cond\",},{M[8],M[0],T\"is_active_c19_Sim_Forcing_003h_expe_infra5_full_control5\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c19_Sim_Forcing_003h_expe_infra5_full_control5_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c19_Sim_Forcing_003h_expe_infra5_full_control5
  (void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c19_Sim_Forcing_003h_expe_infra5_full_control5();
  initialize_c19_Sim_Forcing_003h_expe_infra5_full_control5();
}

static void sf_opaque_enable_c19_Sim_Forcing_003h_expe_infra5_full_control5(void
  *chartInstanceVar)
{
  enable_c19_Sim_Forcing_003h_expe_infra5_full_control5();
}

static void sf_opaque_disable_c19_Sim_Forcing_003h_expe_infra5_full_control5
  (void *chartInstanceVar)
{
  disable_c19_Sim_Forcing_003h_expe_infra5_full_control5();
}

static void sf_opaque_gateway_c19_Sim_Forcing_003h_expe_infra5_full_control5
  (void *chartInstanceVar)
{
  sf_c19_Sim_Forcing_003h_expe_infra5_full_control5();
}

static void
  sf_opaque_ext_mode_exec_c19_Sim_Forcing_003h_expe_infra5_full_control5(void
  *chartInstanceVar)
{
  ext_mode_exec_c19_Sim_Forcing_003h_expe_infra5_full_control5();
}

static mxArray*
  sf_opaque_get_sim_state_c19_Sim_Forcing_003h_expe_infra5_full_control5(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *)
    get_sim_state_c19_Sim_Forcing_003h_expe_infra5_full_control5();
  return st;
}

static void
  sf_opaque_set_sim_state_c19_Sim_Forcing_003h_expe_infra5_full_control5(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c19_Sim_Forcing_003h_expe_infra5_full_control5(sf_mex_dup(st));
}

static void sf_opaque_terminate_c19_Sim_Forcing_003h_expe_infra5_full_control5
  (void *chartInstanceVar)
{
  ...
  finalize_c19_Sim_Forcing_003h_expe_infra5_full_control5();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c19_Sim_Forcing_003h_expe_infra5_full_control5
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c19_Sim_Forcing_003h_expe_infra5_full_control5
  (SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      ...
      "Sim_Forcing_003h_expe_infra5_full_control5",19);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(
                "Sim_Forcing_003h_expe_infra5_full_control5",
                "Sim_Forcing_003h_expe_infra5_full_control5",19,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "Sim_Forcing_003h_expe_infra5_full_control5",
        "Sim_Forcing_003h_expe_infra5_full_control5",19,2);
      sf_mark_chart_reusable_outputs(S,
        "Sim_Forcing_003h_expe_infra5_full_control5",
        "Sim_Forcing_003h_expe_infra5_full_control5",19,5);
    }
...
static void mdlRTW_c19_Sim_Forcing_003h_expe_infra5_full_control5(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c19_Sim_Forcing_003h_expe_infra5_full_control5(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c19_Sim_Forcing_003h_expe_infra5_full_control5;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c19_Sim_Forcing_003h_expe_infra5_full_control5;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c19_Sim_Forcing_003h_expe_infra5_full_control5;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c19_Sim_Forcing_003h_expe_infra5_full_control5;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c19_Sim_Forcing_003h_expe_infra5_full_control5;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c19_Sim_Forcing_003h_expe_infra5_full_control5;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c19_Sim_Forcing_003h_expe_infra5_full_control5;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c19_Sim_Forcing_003h_expe_infra5_full_control5;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW =
    mdlRTW_c19_Sim_Forcing_003h_expe_infra5_full_control5;
  chartInstance.chartInfo.mdlStart =
    mdlStart_c19_Sim_Forcing_003h_expe_infra5_full_control5;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c19_Sim_Forcing_003h_expe_infra5_full_control5;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c19_Sim_Forcing_003h_expe_infra5_full_control5;
...
void c19_Sim_Forcing_003h_expe_infra5_full_control5_method_dispatcher(SimStruct *
  S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c19_Sim_Forcing_003h_expe_infra5_full_control5(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c19_Sim_Forcing_003h_expe_infra5_full_control5(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c19_Sim_Forcing_003h_expe_infra5_full_control5(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c19_Sim_Forcing_003h_expe_infra5_full_control5_method_dispatcher.\n"
