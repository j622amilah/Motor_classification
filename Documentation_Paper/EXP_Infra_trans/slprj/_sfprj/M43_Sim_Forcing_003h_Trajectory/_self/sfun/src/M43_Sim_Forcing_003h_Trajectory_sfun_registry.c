...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_M43_Sim_Forcing_003h_Trajectory_process_check_sum_call(
    int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_M43_Sim_Forcing_003h_Trajectory_process_check_sum_call(nlhs,plhs,nrhs,
       prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_M43_Sim_Forcing_003h_Trajectory_autoinheritance_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_M43_Sim_Forcing_003h_Trajectory_autoinheritance_info(nlhs,plhs,nrhs,
       prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_M43_Sim_Forcing_003h_Trajectory_get_eml_resolved_functions_info( int nlhs,
  ...
  if (strcmp(machineName, "M43_Sim_Forcing_003h_Trajectory") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_M43_Sim_Forcing_003h_Trajectory_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_M43_Sim_Forcing_003h_Trajectory_method_dispatcher
  (SimStruct *S, unsigned int chartFileNumber, int_T method, void *data);
...
{
  if (!strcmp(machineName,"M43_Sim_Forcing_003h_Trajectory")) {
    return(sf_M43_Sim_Forcing_003h_Trajectory_method_dispatcher(simstructPtr,
...
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    M43_Sim_Forcing_003h_Trajectory_terminator();
    sf_debug_terminate();
  }
...
extern void M43_Sim_Forcing_003h_Trajectory_register_exported_symbols(SimStruct*
  S);
extern void M43_Sim_Forcing_003h_Trajectory_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  M43_Sim_Forcing_003h_Trajectory_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      M43_Sim_Forcing_003h_Trajectory_debug_initialize();
    }

    M43_Sim_Forcing_003h_Trajectory_initializer();
  }
