...
static SFc8_M43_Sim_Forcing_003h_TrajectoryInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c8_M43_Sim_Forcing_003h_Trajectory(void);
static void initialize_params_c8_M43_Sim_Forcing_003h_Trajectory(void);
static void enable_c8_M43_Sim_Forcing_003h_Trajectory(void);
static void disable_c8_M43_Sim_Forcing_003h_Trajectory(void);
static void c8_update_debugger_state_c8_M43_Sim_Forcing_003h_Trajectory(void);
static void ext_mode_exec_c8_M43_Sim_Forcing_003h_Trajectory(void);
static const mxArray *get_sim_state_c8_M43_Sim_Forcing_003h_Trajectory(void);
static void set_sim_state_c8_M43_Sim_Forcing_003h_Trajectory(const mxArray
  *c8_st);
static void finalize_c8_M43_Sim_Forcing_003h_Trajectory(void);
static void sf_c8_M43_Sim_Forcing_003h_Trajectory(void);
...
static void initialize_c8_M43_Sim_Forcing_003h_Trajectory(void)
{
  uint8_T *c8_is_active_c8_M43_Sim_Forcing_003h_Trajectory;
  c8_is_active_c8_M43_Sim_Forcing_003h_Trajectory = (uint8_T *)ssGetDWork
    (chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c8_is_active_c8_M43_Sim_Forcing_003h_Trajectory = 0U;
}
...
static void ext_mode_exec_c8_M43_Sim_Forcing_003h_Trajectory(void)
{
  c8_update_debugger_state_c8_M43_Sim_Forcing_003h_Trajectory();
}
...
static const mxArray *get_sim_state_c8_M43_Sim_Forcing_003h_Trajectory(void)
{
  ...
  c8_d_u = *c8_is_active_c8_M43_Sim_Forcing_003h_Trajectory;
  c8_e_y = NULL;
  ...
  *c8_st)
{
  ...
  real_T c8_d2;
  real_T c8_c_y;
  const mxArray *c8_is_active_c8_M43_Sim_Forcing_003h_Trajectory;
  uint8_T c8_u0;
  uint8_T c8_d_y;
  ...
  real_T *c8_x;
  real_T *c8_z;
  uint8_T *c8_b_is_active_c8_M43_Sim_Forcing_003h_Trajectory;
  c8_doneDoubleBufferReInit = (boolean_T *)ssGetDWork(chartInstance.S, 1);
  c8_d_psi = (real_T *)ssGetOutputPortSignal(chartInstance.S, 3);
  c8_z = (real_T *)ssGetOutputPortSignal(chartInstance.S, 2);
  c8_x = (real_T *)ssGetOutputPortSignal(chartInstance.S, 1);
  c8_b_is_active_c8_M43_Sim_Forcing_003h_Trajectory = (uint8_T *)ssGetDWork
    (chartInstance.S, 2);
  *c8_doneDoubleBufferReInit = true;
  c8_u = sf_mex_dup(c8_st);
  c8_psi = sf_mex_dup(sf_mex_getcell(c8_u, 0));
  sf_mex_import("psi", sf_mex_dup(c8_psi), &c8_d0, 1, 0, 0U, 0, 0U, 0);
  c8_y = c8_d0;
  sf_mex_destroy(&c8_psi);
  *c8_d_psi = c8_y;
  c8_b_psi = sf_mex_dup(sf_mex_getcell(c8_u, 1));
  sf_mex_import("x", sf_mex_dup(c8_b_psi), &c8_d1, 1, 0, 0U, 0, 0U, 0);
  c8_b_y = c8_d1;
  sf_mex_destroy(&c8_b_psi);
  *c8_x = c8_b_y;
  c8_c_psi = sf_mex_dup(sf_mex_getcell(c8_u, 2));
  sf_mex_import("z", sf_mex_dup(c8_c_psi), &c8_d2, 1, 0, 0U, 0, 0U, 0);
  c8_c_y = c8_d2;
  sf_mex_destroy(&c8_c_psi);
  *c8_z = c8_c_y;
  c8_is_active_c8_M43_Sim_Forcing_003h_Trajectory = sf_mex_dup(sf_mex_getcell
    (c8_u, 3));
  sf_mex_import("is_active_c8_M43_Sim_Forcing_003h_Trajectory", sf_mex_dup
                (c8_is_active_c8_M43_Sim_Forcing_003h_Trajectory), &c8_u0, 1
                , 3, 0U, 0, 0U, 0);
  c8_d_y = c8_u0;
  sf_mex_destroy(&c8_is_active_c8_M43_Sim_Forcing_003h_Trajectory);
  *c8_b_is_active_c8_M43_Sim_Forcing_003h_Trajectory = c8_d_y;
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_M43_Sim_Forcing_003h_Trajectory();
...
static void sf_c8_M43_Sim_Forcing_003h_Trajectory(void)
{
  ...
  for (c8_i0 = 0; c8_i0 < 6; c8_i0 = c8_i0 + 1) {
    _SFD_DATA_RANGE_CHECK((*c8_b_set)[c8_i0], 0U);
  }
  ...
  for (c8_i1 = 0; c8_i1 < 6; c8_i1 = c8_i1 + 1) {
    c8_set[c8_i1] = (*c8_b_set)[c8_i1];
  }
  ...
  for (c8_i2 = 0; c8_i2 < 3; c8_i2 = c8_i2 + 1) {
    c8_z_p[c8_i2] = c8_set[c8_i2 + 3];
  }

  _SFD_EML_CALL(0,18);
  for (c8_i3 = 0; c8_i3 < 3; c8_i3 = c8_i3 + 1) {
    c8_x_p[c8_i3] = c8_set[c8_i3];
  }

  _SFD_EML_CALL(0,20);
  for (c8_i4 = 0; c8_i4 < 3; c8_i4 = c8_i4 + 1) {
    c8_A[c8_i4] = c8_z_p[c8_i4] * c8_z_p[c8_i4];
  }

  for (c8_i5 = 0; c8_i5 < 3; c8_i5 = c8_i5 + 1) {
    c8_A[c8_i5 + 3] = c8_z_p[c8_i5];
  }
  ...
  for (c8_i8 = 0; c8_i8 < 3; c8_i8 = c8_i8 + 1) {
    c8_b_x_p[c8_i8] = c8_x_p[c8_i8];
  }

  c8_mldivide(c8_b_A, c8_b_x_p, c8_dv0);
  for (c8_i9 = 0; c8_i9 < 3; c8_i9 = c8_i9 + 1) {
    c8_c[c8_i9] = c8_dv0[c8_i9];
  }
...
static void c8_mldivide(real_T c8_A[9], real_T c8_B[3], real_T c8_Y[3])
{
  ...
  real_T c8_hb_y;
  real_T c8_f_z;
  for (c8_i19 = 0; c8_i19 < 9; c8_i19 = c8_i19 + 1) {
    c8_b_A[c8_i19] = c8_A[c8_i19];
  }

  for (c8_i20 = 0; c8_i20 < 3; c8_i20 = c8_i20 + 1) {
    c8_b_B[c8_i20] = c8_B[c8_i20];
  }

  for (c8_i21 = 0; c8_i21 < 9; c8_i21 = c8_i21 + 1) {
    c8_c_A[c8_i21] = c8_b_A[c8_i21];
  }

  for (c8_i22 = 0; c8_i22 < 3; c8_i22 = c8_i22 + 1) {
    c8_c_B[c8_i22] = c8_b_B[c8_i22];
  }
...
static void c8_eml_warning(void)
{
  ...
  char_T c8_b_u[21];
  const mxArray *c8_b_y = NULL;
  for (c8_i23 = 0; c8_i23 < 40; c8_i23 = c8_i23 + 1) {
    c8_u[c8_i23] = c8_cv0[c8_i23];
  }

  c8_y = NULL;
  sf_mex_assign(&c8_y, sf_mex_create("y", &c8_u, 10, 0U, 1U, 0U, 2, 1, 40));
  for (c8_i24 = 0; c8_i24 < 21; c8_i24 = c8_i24 + 1) {
    c8_b_u[c8_i24] = c8_cv1[c8_i24];
  }
...
static const mxArray *c8_sf_marshall(void *c8_chartInstance, void *c8_u)
{
  ...
  c8_y = NULL;
  c8_i25 = 0;
  for (c8_i26 = 0; c8_i26 < 2; c8_i26 = c8_i26 + 1) {
    for (c8_i27 = 0; c8_i27 < 3; c8_i27 = c8_i27 + 1) {
      c8_b_u[c8_i27 + c8_i25] = (*((real_T (*)[6])c8_u))[c8_i27 + c8_i25];
    }
...
static const mxArray *c8_c_sf_marshall(void *c8_chartInstance, void *c8_u)
{
  ...
  for (c8_i28 = 0; c8_i28 < 3; c8_i28 = c8_i28 + 1) {
    c8_b_u[c8_i28] = (*((real_T (*)[3])c8_u))[c8_i28];
  }
...
static const mxArray *c8_d_sf_marshall(void *c8_chartInstance, void *c8_u)
{
  ...
  for (c8_i30 = 0; c8_i30 < 3; c8_i30 = c8_i30 + 1) {
    for (c8_i31 = 0; c8_i31 < 3; c8_i31 = c8_i31 + 1) {
      c8_b_u[c8_i31 + c8_i29] = (*((real_T (*)[9])c8_u))[c8_i31 + c8_i29];
    }
...
const mxArray
  *sf_c8_M43_Sim_Forcing_003h_Trajectory_get_eml_resolved_functions_info(void)
{
  ...
  for (c8_i32 = 0; c8_i32 < 50; c8_i32 = c8_i32 + 1) {
    ...
    sf_mex_addfield(c8_m0, sf_mex_create("nameCaptureInfo", c8_r0->dominantType,
      15, 0U, 0U, 0U, 2, 1, strlen(c8_r0->dominantType)),
                    "dominantType", "nameCaptureInfo", c8_i32);
    ...
    sf_mex_addfield(c8_m0, sf_mex_create("nameCaptureInfo", &c8_r0->fileTime1, 7,
      0U, 0U, 0U, 0), "fileTime1", "nameCaptureInfo", c8_i32
                    );
    sf_mex_addfield(c8_m0, sf_mex_create("nameCaptureInfo", &c8_r0->fileTime2, 7,
      0U, 0U, 0U, 0), "fileTime2", "nameCaptureInfo", c8_i32
                    );
  }
...
/* SFunction Glue Code */
void sf_c8_M43_Sim_Forcing_003h_Trajectory_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(663420674U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1358262419U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(236511944U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2266916100U);
}

mxArray *sf_c8_M43_Sim_Forcing_003h_Trajectory_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(908073470U);
    pr[1] = (double)(456127976U);
    pr[2] = (double)(3967929454U);
    pr[3] = (double)(3867778136U);
...
static mxArray *sf_get_sim_state_info_c8_M43_Sim_Forcing_003h_Trajectory(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[8],T\"psi\",},{M[1],M[5],T\"x\",},{M[1],M[7],T\"z\",},{M[8],M[0],T\"is_active_c8_M43_Sim_Forcing_003h_Trajectory\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_M43_Sim_Forcing_003h_Trajectory_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c8_M43_Sim_Forcing_003h_Trajectory(void
  *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c8_M43_Sim_Forcing_003h_Trajectory();
  initialize_c8_M43_Sim_Forcing_003h_Trajectory();
}

static void sf_opaque_enable_c8_M43_Sim_Forcing_003h_Trajectory(void
  *chartInstanceVar)
{
  enable_c8_M43_Sim_Forcing_003h_Trajectory();
}

static void sf_opaque_disable_c8_M43_Sim_Forcing_003h_Trajectory(void
  *chartInstanceVar)
{
  disable_c8_M43_Sim_Forcing_003h_Trajectory();
}

static void sf_opaque_gateway_c8_M43_Sim_Forcing_003h_Trajectory(void
  *chartInstanceVar)
{
  sf_c8_M43_Sim_Forcing_003h_Trajectory();
}

static void sf_opaque_ext_mode_exec_c8_M43_Sim_Forcing_003h_Trajectory(void
  *chartInstanceVar)
{
  ext_mode_exec_c8_M43_Sim_Forcing_003h_Trajectory();
}

static mxArray* sf_opaque_get_sim_state_c8_M43_Sim_Forcing_003h_Trajectory(void *
  chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c8_M43_Sim_Forcing_003h_Trajectory();
  return st;
}

static void sf_opaque_set_sim_state_c8_M43_Sim_Forcing_003h_Trajectory(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c8_M43_Sim_Forcing_003h_Trajectory(sf_mex_dup(st));
}

static void sf_opaque_terminate_c8_M43_Sim_Forcing_003h_Trajectory(void
  *chartInstanceVar)
{
  ...
  finalize_c8_M43_Sim_Forcing_003h_Trajectory();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_M43_Sim_Forcing_003h_Trajectory(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_M43_Sim_Forcing_003h_Trajectory(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("M43_Sim_Forcing_003h_Trajectory",
      "M43_Sim_Forcing_003h_Trajectory",8);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("M43_Sim_Forcing_003h_Trajectory",
                "M43_Sim_Forcing_003h_Trajectory",8,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(
      "M43_Sim_Forcing_003h_Trajectory","M43_Sim_Forcing_003h_Trajectory",8,
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"M43_Sim_Forcing_003h_Trajectory",
        "M43_Sim_Forcing_003h_Trajectory",8,3);
  ...
  ssSetChecksum0(S,(2517832279U));
  ssSetChecksum1(S,(3880080872U));
  ssSetChecksum2(S,(2275600684U));
  ssSetChecksum3(S,(19907306U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c8_M43_Sim_Forcing_003h_Trajectory(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_M43_Sim_Forcing_003h_Trajectory(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_M43_Sim_Forcing_003h_Trajectory;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c8_M43_Sim_Forcing_003h_Trajectory;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c8_M43_Sim_Forcing_003h_Trajectory;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c8_M43_Sim_Forcing_003h_Trajectory;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c8_M43_Sim_Forcing_003h_Trajectory;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_M43_Sim_Forcing_003h_Trajectory;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_M43_Sim_Forcing_003h_Trajectory;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_M43_Sim_Forcing_003h_Trajectory;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c8_M43_Sim_Forcing_003h_Trajectory;
  chartInstance.chartInfo.mdlStart = mdlStart_c8_M43_Sim_Forcing_003h_Trajectory;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_M43_Sim_Forcing_003h_Trajectory;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c8_M43_Sim_Forcing_003h_Trajectory;
...
void c8_M43_Sim_Forcing_003h_Trajectory_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_M43_Sim_Forcing_003h_Trajectory(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_M43_Sim_Forcing_003h_Trajectory(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_M43_Sim_Forcing_003h_Trajectory(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_M43_Sim_Forcing_003h_Trajectory_method_dispatcher.\n"
