...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_M32_getnsave_data_infra_trans_process_check_sum_call
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_M32_getnsave_data_infra_trans_process_check_sum_call(nlhs,plhs,nrhs,
       prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_M32_getnsave_data_infra_trans_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_M32_getnsave_data_infra_trans_autoinheritance_info(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_M32_getnsave_data_infra_trans_get_eml_resolved_functions_info( int nlhs,
  ...
  if (strcmp(machineName, "M32_getnsave_data_infra_trans") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_M32_getnsave_data_infra_trans_get_eml_resolved_functions_info(nlhs,
      plhs,2,newRhs);
  }
...
extern unsigned int sf_M32_getnsave_data_infra_trans_method_dispatcher(SimStruct
...
{
  if (!strcmp(machineName,"M32_getnsave_data_infra_trans")) {
    return(sf_M32_getnsave_data_infra_trans_method_dispatcher(simstructPtr,
...
extern void M32_getnsave_data_infra_trans_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    M32_getnsave_data_infra_trans_terminator();
    sf_debug_terminate();
  }
...
extern void M32_getnsave_data_infra_trans_initializer(void);
extern void M32_getnsave_data_infra_trans_register_exported_symbols(SimStruct* S);
extern void M32_getnsave_data_infra_trans_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  M32_getnsave_data_infra_trans_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      M32_getnsave_data_infra_trans_debug_initialize();
    }

    M32_getnsave_data_infra_trans_initializer();
  }
