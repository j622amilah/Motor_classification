...
static SFc7_M37_Sim_Forcing_003h_expe_infra_transz_limInstanceStruct
  chartInstance;

/* Function Declarations */
static void initialize_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static void initialize_params_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static void enable_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static void disable_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static void c7_update_debugger_state_c7_M37_Sim_Forcing_003h_expe_infra_tra(void);
static void ext_mode_exec_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static const mxArray
  *get_sim_state_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static void set_sim_state_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(const
  mxArray *c7_st);
static void finalize_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static void sf_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
...
static void initialize_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void)
{
  uint8_T *c7_is_active_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  c7_is_active_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c7_is_active_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim = 0U;
}
...
static void ext_mode_exec_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void)
{
  c7_update_debugger_state_c7_M37_Sim_Forcing_003h_expe_infra_tra();
}
  ...
  *get_sim_state_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void)
{
  ...
  c7_b_u = *c7_is_active_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  c7_c_y = NULL;
  ...
  mxArray *c7_st)
{
  ...
  real_T c7_d0;
  real_T c7_y;
  const mxArray *c7_is_active_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  uint8_T c7_u0;
  uint8_T c7_b_y;
  boolean_T *c7_doneDoubleBufferReInit;
  real_T *c7_b_max_tilt;
  uint8_T *c7_b_is_active_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  c7_b_is_active_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  ...
  *c7_b_max_tilt = c7_y;
  c7_is_active_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim = sf_mex_dup
    (sf_mex_getcell(c7_u, 1));
  sf_mex_import("is_active_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim",
                sf_mex_dup(
    c7_is_active_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim), &c7_u0, 1, 3,
                0U, 0, 0U, 0);
  c7_b_y = c7_u0;
  sf_mex_destroy(&c7_is_active_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim);
  *c7_b_is_active_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim = c7_b_y;
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_M37_Sim_Forcing_003h_expe_infra_tra();
...
static void sf_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void)
{
  ...
  real_T c7_b_mtmp;
  real_T *c7_b_max_tilt;
  real_T (*c7_b_com_or)[3];
  c7_b_max_tilt = (real_T *)ssGetOutputPortSignal(chartInstance.S, 1);
  c7_b_com_or = (real_T (*)[3])ssGetInputPortSignal(chartInstance.S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  ...
  c7_varargin_1[0] = c7_c_y;
  c7_varargin_1[1] = c7_b_y;
  c7_varargin_1[2] = c7_y;
  for (c7_i2 = 0; c7_i2 < 3; c7_i2 = c7_i2 + 1) {
    c7_g_x[c7_i2] = c7_varargin_1[c7_i2];
  }

  for (c7_i3 = 0; c7_i3 < 3; c7_i3 = c7_i3 + 1) {
    c7_h_x[c7_i3] = c7_g_x[c7_i3];
  }
  ...
  if (c7_b) {
   ...
   label_1:
    ...
    if (c7_k < 4) {
      ...
      c7_a = c7_ix;
      c7_ix = c7_a + 1;
      c7_j_x = c7_h_x[_SFD_EML_ARRAY_BOUNDS_CHECK("x", (int32_T)
        _SFD_INTEGER_CHECK("ix", (real_T)c7_ix), 1, 3, 1, 0) - 1];
      c7_b_b = rtIsNaN(c7_j_x);
      if (!c7_b_b) {
        c7_mtmp = c7_h_x[_SFD_EML_ARRAY_BOUNDS_CHECK("x", (int32_T)
          _SFD_INTEGER_CHECK("ix", (real_T)c7_ix), 1, 3, 1, 0) - 1];
        c7_itmp = c7_b_k;
  ...
  c7_b_a = c7_itmp;
  c7_i4 = c7_b_a + 1;
  for (c7_c_k = c7_i4; c7_c_k < 4; c7_c_k = c7_c_k + 1) {
    c7_c_a = c7_ix;
    c7_ix = c7_c_a + 1;
    if (c7_h_x[_SFD_EML_ARRAY_BOUNDS_CHECK("x", (int32_T)_SFD_INTEGER_CHECK("ix",
          (real_T)c7_ix), 1, 3, 1, 0) - 1] > c7_mtmp) {
      c7_mtmp = c7_h_x[_SFD_EML_ARRAY_BOUNDS_CHECK("x", (int32_T)
        _SFD_INTEGER_CHECK("ix", (real_T)c7_ix), 1, 3, 1, 0) - 1];
    }
  }
...
static const mxArray *c7_sf_marshall(void *c7_chartInstance, void *c7_u)
{
  ...
  for (c7_i5 = 0; c7_i5 < 3; c7_i5 = c7_i5 + 1) {
    c7_b_u[c7_i5] = (*((real_T (*)[3])c7_u))[c7_i5];
  }
...
/* SFunction Glue Code */
void sf_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim_get_check_sum(mxArray
  *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3362819971U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2768077421U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(176000756U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3756683592U);
}
  ...
  (void)
{
...

  {
    ...
    pr[0] = (double)(3215701380U);
    pr[1] = (double)(2051773105U);
    pr[2] = (double)(2824051466U);
    pr[3] = (double)(4262350443U);
...
static mxArray
  *sf_get_sim_state_info_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"max_tilt\",},{M[8],M[0],T\"is_active_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T *c7_max_tilt;
          c7_max_tilt = (real_T *)ssGetOutputPortSignal(chartInstance.S, 1);
          c7_com_or = (real_T (*)[3])ssGetInputPortSignal(chartInstance.S, 0);
...
static void sf_opaque_initialize_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim
  (void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim();
  initialize_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim();
}

static void sf_opaque_enable_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void *
  chartInstanceVar)
{
  enable_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim();
}

static void sf_opaque_disable_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void
  *chartInstanceVar)
{
  disable_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim();
}

static void sf_opaque_gateway_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void
  *chartInstanceVar)
{
  sf_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim();
}

static void
  sf_opaque_ext_mode_exec_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void
  *chartInstanceVar)
{
  ext_mode_exec_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim();
}

static mxArray*
  sf_opaque_get_sim_state_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *)
    get_sim_state_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim();
  return st;
}

static void
  sf_opaque_set_sim_state_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(sf_mex_dup(st));
}

static void sf_opaque_terminate_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim
  (void *chartInstanceVar)
{
  ...
  finalize_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("M37_Sim_Forcing_003h_expe_infra_transz_lim",
      "M37_Sim_Forcing_003h_expe_infra_transz_lim",7);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(
                "M37_Sim_Forcing_003h_expe_infra_transz_lim",
                "M37_Sim_Forcing_003h_expe_infra_transz_lim",7,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "M37_Sim_Forcing_003h_expe_infra_transz_lim",
        "M37_Sim_Forcing_003h_expe_infra_transz_lim",7,1);
  ...
  ssSetChecksum0(S,(2609371779U));
  ssSetChecksum1(S,(484616460U));
  ssSetChecksum2(S,(832273078U));
  ssSetChecksum3(S,(1263376746U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW =
    mdlRTW_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.mdlStart =
    mdlStart_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim;
...
void c7_M37_Sim_Forcing_003h_expe_infra_transz_lim_method_dispatcher(SimStruct
  *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_M37_Sim_Forcing_003h_expe_infra_transz_lim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_M37_Sim_Forcing_003h_expe_infra_transz_lim_method_dispatcher.\n"
