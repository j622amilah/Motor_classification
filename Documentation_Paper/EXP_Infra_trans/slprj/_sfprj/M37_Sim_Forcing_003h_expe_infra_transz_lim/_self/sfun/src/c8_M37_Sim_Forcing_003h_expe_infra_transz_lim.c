...
static SFc8_M37_Sim_Forcing_003h_expe_infra_transz_limInstanceStruct
  chartInstance;

/* Function Declarations */
static void initialize_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static void initialize_params_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static void enable_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static void disable_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static void c8_update_debugger_state_c8_M37_Sim_Forcing_003h_expe_infra_tra(void);
static void ext_mode_exec_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static const mxArray
  *get_sim_state_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static void set_sim_state_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(const
  mxArray *c8_st);
static void finalize_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static void sf_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
...
static void initialize_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(void)
{
  uint8_T *c8_is_active_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  c8_is_active_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c8_is_active_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim = 0U;
}
...
static void ext_mode_exec_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(void)
{
  c8_update_debugger_state_c8_M37_Sim_Forcing_003h_expe_infra_tra();
}
  ...
  *get_sim_state_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(void)
{
  ...
  c8_f_u = *c8_is_active_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  c8_g_y = NULL;
  ...
  mxArray *c8_st)
{
  ...
  real_T c8_e_y[3];
  int32_T c8_i5;
  const mxArray *c8_is_active_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  uint8_T c8_u0;
  uint8_T c8_f_y;
  ...
  real_T *c8_x;
  real_T *c8_z;
  uint8_T *c8_b_is_active_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  real_T (*c8_c_c)[3];
  real_T (*c8_z_p)[3];
  ...
  c8_x = (real_T *)ssGetOutputPortSignal(chartInstance.S, 1);
  c8_b_is_active_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  ...
  *c8_z = c8_d_y;
  ...
  c8_is_active_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim = sf_mex_dup
    (sf_mex_getcell(c8_u, 5));
  sf_mex_import("is_active_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim",
                sf_mex_dup(
    c8_is_active_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim), &c8_u0, 1, 3,
                0U, 0, 0U, 0);
  c8_f_y = c8_u0;
  sf_mex_destroy(&c8_is_active_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim);
  *c8_b_is_active_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim = c8_f_y;
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_M37_Sim_Forcing_003h_expe_infra_tra();
...
/* SFunction Glue Code */
void sf_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim_get_check_sum(mxArray
  *plhs[])
{
...
static mxArray
  *sf_get_sim_state_info_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[10],T\"c\",},{M[1],M[8],T\"psi\",},{M[1],M[5],T\"x\",},{M[1],M[7],T\"z\",},{M[1],M[11],T\"z_p\",},{M[8],M[0],T\"is_active_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim
  (void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim();
  initialize_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim();
}

static void sf_opaque_enable_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(void *
  chartInstanceVar)
{
  enable_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim();
}

static void sf_opaque_disable_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(void
  *chartInstanceVar)
{
  disable_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim();
}

static void sf_opaque_gateway_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(void
  *chartInstanceVar)
{
  sf_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim();
}

static void
  sf_opaque_ext_mode_exec_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(void
  *chartInstanceVar)
{
  ext_mode_exec_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim();
}

static mxArray*
  sf_opaque_get_sim_state_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *)
    get_sim_state_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim();
  return st;
}

static void
  sf_opaque_set_sim_state_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(sf_mex_dup(st));
}

static void sf_opaque_terminate_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim
  (void *chartInstanceVar)
{
  ...
  finalize_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("M37_Sim_Forcing_003h_expe_infra_transz_lim",
      "M37_Sim_Forcing_003h_expe_infra_transz_lim",8);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(
                "M37_Sim_Forcing_003h_expe_infra_transz_lim",
                "M37_Sim_Forcing_003h_expe_infra_transz_lim",8,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "M37_Sim_Forcing_003h_expe_infra_transz_lim",
        "M37_Sim_Forcing_003h_expe_infra_transz_lim",8,3);
      sf_mark_chart_reusable_outputs(S,
        "M37_Sim_Forcing_003h_expe_infra_transz_lim",
        "M37_Sim_Forcing_003h_expe_infra_transz_lim",8,5);
    }
...
static void mdlRTW_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW =
    mdlRTW_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.mdlStart =
    mdlStart_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim;
...
void c8_M37_Sim_Forcing_003h_expe_infra_transz_lim_method_dispatcher(SimStruct
  *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_M37_Sim_Forcing_003h_expe_infra_transz_lim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_M37_Sim_Forcing_003h_expe_infra_transz_lim_method_dispatcher.\n"
