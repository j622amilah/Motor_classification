...
{
  extern unsigned int
    sf_M37_Sim_Forcing_003h_expe_infra_transz_lim_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_M37_Sim_Forcing_003h_expe_infra_transz_lim_process_check_sum_call(nlhs,
       plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_M37_Sim_Forcing_003h_expe_infra_transz_lim_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_M37_Sim_Forcing_003h_expe_infra_transz_lim_autoinheritance_info(nlhs,
       plhs,nrhs,prhs))
    return 1;
  return 0;
}
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "M37_Sim_Forcing_003h_expe_infra_transz_lim") == 0) {
...
extern unsigned int
  sf_M37_Sim_Forcing_003h_expe_infra_transz_lim_method_dispatcher(SimStruct *S,
...
{
  if (!strcmp(machineName,"M37_Sim_Forcing_003h_expe_infra_transz_lim")) {
    return(sf_M37_Sim_Forcing_003h_expe_infra_transz_lim_method_dispatcher
...
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    M37_Sim_Forcing_003h_expe_infra_transz_lim_terminator();
    sf_debug_terminate();
  }
...
extern void M37_Sim_Forcing_003h_expe_infra_transz_lim_register_exported_symbols
  (SimStruct* S);
extern void M37_Sim_Forcing_003h_expe_infra_transz_lim_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  M37_Sim_Forcing_003h_expe_infra_transz_lim_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      M37_Sim_Forcing_003h_expe_infra_transz_lim_debug_initialize();
    }

    M37_Sim_Forcing_003h_expe_infra_transz_lim_initializer();
  }
