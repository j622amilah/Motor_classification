...
static SFc5_M37_Sim_Forcing_003h_expe_infra_transz_limInstanceStruct
  chartInstance;

/* Function Declarations */
static void initialize_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static void initialize_params_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static void enable_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static void disable_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static void c5_update_debugger_state_c5_M37_Sim_Forcing_003h_expe_infra_tra(void);
static void ext_mode_exec_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static const mxArray
  *get_sim_state_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static void set_sim_state_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(const
  mxArray *c5_st);
static void finalize_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
static void sf_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void);
...
static void initialize_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void)
{
  uint8_T *c5_is_active_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  c5_is_active_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  *c5_is_active_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim = 0U;
}
...
static void ext_mode_exec_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void)
{
  c5_update_debugger_state_c5_M37_Sim_Forcing_003h_expe_infra_tra();
}
  ...
  *get_sim_state_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void)
{
  ...
  c5_gain = (real_T *)ssGetOutputPortSignal(chartInstance.S, 2);
  c5_is_active_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  c5_st = NULL;
  c5_y = NULL;
  ...
  c5_c_u = *c5_is_active_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  c5_d_y = NULL;
...
{
  const mxArray *c5_u;
  const mxArray *c5_gain;
  real_T c5_d0;
  real_T c5_y;
  const mxArray *c5_b_gain;
  real_T c5_d1;
  real_T c5_b_y;
  const mxArray *c5_is_active_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  uint8_T c5_u0;
  uint8_T c5_c_y;
  boolean_T *c5_doneDoubleBufferReInit;
  real_T *c5_c_gain;
  real_T *c5_d_y;
  uint8_T *c5_b_is_active_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  c5_d_y = (real_T *)ssGetOutputPortSignal(chartInstance.S, 1);
  c5_c_gain = (real_T *)ssGetOutputPortSignal(chartInstance.S, 2);
  c5_b_is_active_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim = (uint8_T *)
    ssGetDWork(chartInstance.S, 2);
  c5_doneDoubleBufferReInit = (boolean_T *)ssGetDWork(chartInstance.S, 1);
  *c5_doneDoubleBufferReInit = true;
  c5_u = sf_mex_dup(c5_st);
  c5_gain = sf_mex_dup(sf_mex_getcell(c5_u, 0));
  sf_mex_import("gain", sf_mex_dup(c5_gain), &c5_d0, 1, 0, 0U, 0, 0U, 0);
  c5_y = c5_d0;
  sf_mex_destroy(&c5_gain);
  *c5_c_gain = c5_y;
  c5_b_gain = sf_mex_dup(sf_mex_getcell(c5_u, 1));
  sf_mex_import("y", sf_mex_dup(c5_b_gain), &c5_d1, 1, 0, 0U, 0, 0U, 0);
  c5_b_y = c5_d1;
  sf_mex_destroy(&c5_b_gain);
  *c5_d_y = c5_b_y;
  c5_is_active_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim = sf_mex_dup
    (sf_mex_getcell(c5_u, 2));
  sf_mex_import("is_active_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim",
                sf_mex_dup(
    c5_is_active_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim), &c5_u0, 1, 3,
                0U, 0, 0U, 0);
  c5_c_y = c5_u0;
  sf_mex_destroy(&c5_is_active_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim);
  *c5_b_is_active_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim = c5_c_y;
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_M37_Sim_Forcing_003h_expe_infra_tra();
...
static void sf_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void)
{
  ...
  real_T *c5_b_y_in;
  real_T *c5_b_gain;
  c5_b_y_in = (real_T *)ssGetInputPortSignal(chartInstance.S, 5);
  c5_b_margin_min = (real_T *)ssGetInputPortSignal(chartInstance.S, 4);
  c5_b_x_min = (real_T *)ssGetInputPortSignal(chartInstance.S, 2);
  c5_ab_y = (real_T *)ssGetOutputPortSignal(chartInstance.S, 1);
  c5_b_gain = (real_T *)ssGetOutputPortSignal(chartInstance.S, 2);
  c5_kb_x = (real_T *)ssGetInputPortSignal(chartInstance.S, 0);
  ...
  _SFD_DATA_RANGE_CHECK(*c5_kb_x, 0U);
  _SFD_DATA_RANGE_CHECK(*c5_ab_y, 1U);
  ...
  _SFD_DATA_RANGE_CHECK(*c5_b_y_in, 6U);
  _SFD_DATA_RANGE_CHECK(*c5_b_gain, 7U);
  ...
  sf_debug_symbol_scope_add("gain", &c5_gain, c5_sf_marshall);
  sf_debug_symbol_scope_add("y", &c5_y, c5_sf_marshall);
  sf_debug_symbol_scope_add("y_in", &c5_y_in, c5_sf_marshall);
  ...
  if (CV_EML_IF(0, 2, c5_x >= c5_x_max - c5_margin_max)) {
    ...
    c5_p_x = c5_o_x;
    c5_m_y = c5_l_y;
    c5_q_x = c5_p_x / c5_m_y;
    c5_gain = c5_q_x;
    c5_r_x = c5_gain;
    c5_gain = c5_r_x;
    c5_gain = muDoubleScalarExp(c5_gain);
  } else {
    _SFD_EML_CALL(0,29);
    c5_x1 = (c5_x + c5_x_min) - c5_margin_min;
    _SFD_EML_CALL(0,30);
    c5_c_a = -c5_x_min;
    c5_d_A = c5_margin_min;
    c5_d_B = c5_x_min;
    c5_s_x = c5_d_A;
    c5_n_y = c5_d_B;
    if (c5_n_y == 0.0) {
    ...
    c5_u_x = c5_t_x;
    c5_p_y = c5_o_y;
    c5_d_a = c5_u_x / c5_p_y;
    c5_v_x = c5_x1;
    c5_w_x = c5_v_x;
    c5_q_y = muDoubleScalarAbs(c5_w_x);
    c5_e_A = -c5_q_y;
    c5_e_B = c5_margin_min;
    c5_x_x = c5_e_A;
    c5_r_y = c5_e_B;
    if (c5_r_y == 0.0) {
      c5_eml_warning();
    ...
    c5_ab_x = c5_y_x;
    c5_t_y = c5_s_y;
    c5_bb_x = c5_ab_x / c5_t_y;
    c5_c_b = c5_bb_x;
    c5_cb_x = c5_c_b;
    c5_c_b = c5_cb_x;
    c5_c_b = muDoubleScalarExp(c5_c_b);
    c5_u_y = c5_d_a * c5_c_b;
    c5_d_b = 1.0 - c5_u_y;
    c5_y = c5_c_a * c5_d_b;
    _SFD_EML_CALL(0,31);
    c5_db_x = c5_x1;
    c5_eb_x = c5_db_x;
    c5_v_y = muDoubleScalarAbs(c5_eb_x);
    c5_f_A = -c5_v_y;
    c5_f_B = c5_margin_max;
    c5_fb_x = c5_f_A;
    c5_w_y = c5_f_B;
    if (c5_w_y == 0.0) {
      c5_eml_warning();
...
/* SFunction Glue Code */
void sf_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim_get_check_sum(mxArray
  *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3079429101U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3347839804U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1199782176U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1702505027U);
}
  ...
  (void)
{
...

  {
    ...
    pr[0] = (double)(220176262U);
    pr[1] = (double)(3265907462U);
    pr[2] = (double)(2150746121U);
    pr[3] = (double)(1911330286U);
...
static mxArray
  *sf_get_sim_state_info_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[11],T\"gain\",},{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim_get_check_sum(&mxChecksum);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1156);
        _SFD_CV_INIT_EML_IF(0,0,665,700,736,1152);
        _SFD_CV_INIT_EML_IF(0,1,736,775,811,1152);
        _SFD_CV_INIT_EML_IF(0,2,811,841,993,1152);

        {
          static int condStart[] = { 668, 694 };

          static int condEnd[] = { 690, 700 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,0,668,700,2,0,&(condStart[0]),&(condEnd[0]),3,
                                &(pfixExpr[0]));
        }

        {
          static int condStart[] = { 743, 770 };

          static int condEnd[] = { 766, 775 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,743,775,2,2,&(condStart[0]),&(condEnd[0]),3,
                                &(pfixExpr[0]));
        }
...

        {
          ...
          real_T *c5_y_in;
          real_T *c5_gain;
          c5_y_in = (real_T *)ssGetInputPortSignal(chartInstance.S, 5);
          ...
          _SFD_SET_DATA_VALUE_PTR(6U, c5_y_in);
          _SFD_SET_DATA_VALUE_PTR(7U, c5_gain);
        }
      }
    } else {
...
static void sf_opaque_initialize_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim
  (void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim();
  initialize_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim();
}

static void sf_opaque_enable_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void *
  chartInstanceVar)
{
  enable_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim();
}

static void sf_opaque_disable_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void
  *chartInstanceVar)
{
  disable_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim();
}

static void sf_opaque_gateway_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void
  *chartInstanceVar)
{
  sf_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim();
}

static void
  sf_opaque_ext_mode_exec_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void
  *chartInstanceVar)
{
  ext_mode_exec_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim();
}

static mxArray*
  sf_opaque_get_sim_state_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *)
    get_sim_state_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim();
  return st;
}

static void
  sf_opaque_set_sim_state_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(sf_mex_dup(st));
}

static void sf_opaque_terminate_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim
  (void *chartInstanceVar)
{
  ...
  finalize_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("M37_Sim_Forcing_003h_expe_infra_transz_lim",
      "M37_Sim_Forcing_003h_expe_infra_transz_lim",5);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(
                "M37_Sim_Forcing_003h_expe_infra_transz_lim",
                "M37_Sim_Forcing_003h_expe_infra_transz_lim",5,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "M37_Sim_Forcing_003h_expe_infra_transz_lim",
        "M37_Sim_Forcing_003h_expe_infra_transz_lim",5,6);
      sf_mark_chart_reusable_outputs(S,
        "M37_Sim_Forcing_003h_expe_infra_transz_lim",
        "M37_Sim_Forcing_003h_expe_infra_transz_lim",5,2);
    }
  ...
  ssSetChecksum0(S,(1366249528U));
  ssSetChecksum1(S,(3589200144U));
  ssSetChecksum2(S,(2574686609U));
  ssSetChecksum3(S,(3110332247U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW =
    mdlRTW_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.mdlStart =
    mdlStart_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim;
  chartInstance.chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim;
...
void c5_M37_Sim_Forcing_003h_expe_infra_transz_lim_method_dispatcher(SimStruct
  *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_M37_Sim_Forcing_003h_expe_infra_transz_lim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_M37_Sim_Forcing_003h_expe_infra_transz_lim_method_dispatcher.\n"
