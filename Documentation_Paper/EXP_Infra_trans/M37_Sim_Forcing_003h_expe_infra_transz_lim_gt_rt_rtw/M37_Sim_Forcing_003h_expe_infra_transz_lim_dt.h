/*
 * M37_Sim_Forcing_003h_expe_infra_transz_lim_dt.h
 *
...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)
    (&M37_Sim_Forcing_003h_expe_infra_transz_lim_B.DiscreteTimeIntegrator1), 0,
    0, 408 },

  { (char_T *)(&M37_Sim_Forcing_003h_expe_infra_transz_lim_B.Gain_c), 21, 0, 6 },

  { (char_T *)(&M37_Sim_Forcing_003h_expe_infra_transz_lim_B.Unpack_o2), 1, 0,
    71 },

  { (char_T *)(&M37_Sim_Forcing_003h_expe_infra_transz_lim_B.GTRTUDPRX_o6), 6, 0,
    9 },

  { (char_T *)(&M37_Sim_Forcing_003h_expe_infra_transz_lim_B.GTRTUDPRX_o2), 7, 0,
    6 },

  { (char_T *)(&M37_Sim_Forcing_003h_expe_infra_transz_lim_B.GTRTUDPRX_o5), 5, 0,
    2 },

  { (char_T *)(&M37_Sim_Forcing_003h_expe_infra_transz_lim_B.GTRTUDPRX_o1[0]), 3,
    0, 396 },

  { (char_T *)(&M37_Sim_Forcing_003h_expe_infra_transz_lim_B.GTRTUDPRX_o3), 8, 0,
    21 },
  ...
  { (char_T *)(&M37_Sim_Forcing_003h_expe_infra_transz_lim_DWork.GTRTUDPRX_PWORK),
    11, 0, 27 },
  ...
  { (char_T *)
    (&M37_Sim_Forcing_003h_expe_infra_transz_lim_DWork.Counter_ClkEphState), 7,
    0, 2 },

  { (char_T *)(&M37_Sim_Forcing_003h_expe_infra_transz_lim_DWork.GTRTUDPRX_IWORK),
    10, 0, 50 },

  { (char_T *)
    (&M37_Sim_Forcing_003h_expe_infra_transz_lim_DWork.UnitDelay_DSTATE_c0), 8,
    0, 4 },
  ...
  { (char_T *)(&M37_Sim_Forcing_003h_expe_infra_transz_lim_DWork.Counter_Count),
    3, 0, 39 },

  { (char_T *)(&M37_Sim_Forcing_003h_expe_infra_transz_lim_DWork.isStable), 8, 0,
    34 },
...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&M37_Sim_Forcing_003h_expe_infra_transz_lim_P.GTRTUDPRX_P1_Size[0]),
    0, 0, 1565 },
  ...
  { (char_T *)(&M37_Sim_Forcing_003h_expe_infra_transz_lim_P.Constant3_Value_b),
    7, 0, 8 },

  { (char_T *)(&M37_Sim_Forcing_003h_expe_infra_transz_lim_P.Gain_Gain_f), 6, 0,
    6 },

  { (char_T *)
    (&M37_Sim_Forcing_003h_expe_infra_transz_lim_P.shift_Power2Exponent), 4, 0,
    18 },

  { (char_T *)(&M37_Sim_Forcing_003h_expe_infra_transz_lim_P.Constant2_Value_gm),
    5, 0, 3 },

  { (char_T *)
    (&M37_Sim_Forcing_003h_expe_infra_transz_lim_P.Counter_InitialCount), 3, 0,
    14 },

  { (char_T *)(&M37_Sim_Forcing_003h_expe_infra_transz_lim_P.UnitDelay_X0_fb), 8,
    0, 4 },

  { (char_T *)(&M37_Sim_Forcing_003h_expe_infra_transz_lim_P.Gain2_Gain_mbx), 3,
    0, 18 },
...
/* [EOF] M37_Sim_Forcing_003h_expe_infra_transz_lim_dt.h */
