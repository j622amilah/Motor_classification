# Copyright 2008 GIGATRONIK Stuttgart GmbH
#
# $Id: M37_Sim_Forcing_003h_expe_infra_transz_lim.mk 390 2011-02-14 10:37:27Z gt\traef $
#
# Abstract:
...
MODEL                = M37_Sim_Forcing_003h_expe_infra_transz_lim
MODULES              = M37_Sim_Forcing_003h_expe_infra_transz_lim_data.c rtGetInf.c rtGetNaN.c rt_atan2_snf.c rt_logging.c rt_matrx.c rt_mod_snf.c rt_nonfinite.c rt_pow_snf.c rt_printf.c 
MAKEFILE             = M37_Sim_Forcing_003h_expe_infra_transz_lim.mk
S_FUNCTIONS          = gt_rt_udp_send.c gt_rt_udp_controller.c gt_rt_can_send.c gt_rt_udp_receive.c gt_rt_can_receive.c gt_rt_can_controller.c
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 1
TID01EQ              = 0
NCSTATES             = 0
COMPUTER             = GLNX86
BUILDARGS            =  GENERATE_REPORT=0 EXT_MODE=1 EXTMODE_STATIC_ALLOC=0 TMW_EXTMODE_TESTING=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 GT_RT_USER="gtrt" GT_RT_ARGS=""
MULTITASKING         = 0
EXT_MODE             = 1
TMW_EXTMODE_TESTING  = 0
EXTMODE_TRANSPORT    = 0
EXTMODE_STATIC       = 0
EXTMODE_STATIC_SIZE  = 0
MEXEXT               = mexw32
...
MODELLIB                  = M37_Sim_Forcing_003h_expe_infra_transz_limlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-IC:/Imose/BEC/Euromov/Motion_Patterns/EXP_Infra_trans/M37_Sim_Forcing_003h_expe_infra_transz_lim_gt_rt_rtw \
	-IC:/Imose/BEC/Euromov/Motion_Patterns/EXP_Infra_trans \
...
ifeq ($(EXT_MODE),1)
  ...
  ifeq ($(EXTMODE_TRANSPORT),0) #tcpip
    # TMW has replaced ext_svr_tcpip_transport.c
    # by rtiostream_interface.c, rtiostream_tcpip.c
...
CPP_REQ_DEFINES = -DMODEL=$(MODEL) -DRT -DNUMST=$(NUMST) \
                  ...
                  -DG_LOG_DOMAIN=\"main\" -DSIMULINKUSER=\"$(SIMULINKUSER)\" -DSIMULINKHOST=\"$(SIMULINKHOST)\"


CFLAGS   = $(CC_OPTS) $(CPP_REQ_DEFINES) $(INCLUDES)
CPPFLAGS = $(CPP_OPTS) $(CC_OPTS) $(CPP_ANSI_OPTS) $(CPP_REQ_DEFINES) $(INCLUDES)

LDFLAGS = -lpthread -lrt -lgtrt -lgtrtmonitor -lgtrtxcp -lglib-2.0 # -m32 -lgtrttpt
...
ifeq ($(MODELREF_TARGET_TYPE), NONE)
    ...
    SRCS               += $(MODEL).$(TARGET_LANG_EXT) gt_rt_main.c rt_sim.c $(EXT_SRC) $(SOLVER)
else
...
purge : clean
	...
	@\rm -f $(MODEL).c $(MODEL).h $(MODEL)_types.h $(MODEL)_data.c \
	        $(MODEL)_private.h $(MODEL).rtw $(MODULES) $(MAKEFILE)

clean :
	@echo "### Deleting the objects and $(PRODUCT)"
	@\rm -f $(LINK_OBJS) $(PRODUCT)

# EOF: M37_Sim_Forcing_003h_expe_infra_transz_lim.mk
