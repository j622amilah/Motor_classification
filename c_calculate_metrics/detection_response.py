...
def detection_response():
    ...
    for exp in range(2):  # 0=rotation, 1=translation
        ...
        for s in subs:
            ...
            speed_stim_DD_out = dat[s][0]        # 3 : 
            axis_out = dat[s][1]                # 3 : axis_out
            
            new3_ind_st = dat[s][2]             # 7 : new3_ind_st
            new3_ind_end = dat[s][3]            # 8 : new3_ind_end
            
            outSIGCOM = dat[s][4]               # 9 : outSIGCOM
            outSIG = dat[s][5]                 # 10 : outSIG
            outJOY = dat[s][6]                 # 11 : outJOY
            outNOISE = dat[s][7]               # 12 : outNOISE
            
            trialnum_org = dat[s][8]           # 13 : trialnum_org
            time = dat[s][9]                   # 14 : time_org
            SSQ = dat[s][10]                    # 15 : SSQ
            FRT_em = dat[s][11]                 # 16 : FRT
            ...
            # [1] response_type (diagram categorisation) : (res_type : a number from 1 to 10 identifying participant response),
