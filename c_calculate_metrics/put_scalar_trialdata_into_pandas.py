...
def put_scalar_trialdata_into_pandas():

    varr = {}
    varr['main_path'] = "C:\\Users\\jamilah\\Documents\\Github_analysis_PROJECTS\\Motor_classification"
    ...
    for exp in range(2):  # 0=rotation, 1=translation
        ...
        if exp == 0:
            ...
            file_name1 = "C:\\Users\\jamilah\\Documents\\Github_analysis_PROJECTS\\Motor_classification\\rotdat2.pkl"

            # Load data experimental preprocessed data matrix
            file_name2 = "C:\\Users\\jamilah\\Documents\\Github_analysis_PROJECTS\\Motor_classification\\rot_Xexp.pkl"
        elif exp == 1:
            ...
            # Time series data per subject per trial
            file_name1 = "C:\\Users\\jamilah\\Documents\\Github_analysis_PROJECTS\\Motor_classification\\transdat2.pkl"

            # Experimental preprocessed : a scalar metric per subject per trial
            file_name2 = "C:\\Users\\jamilah\\Documents\\Github_analysis_PROJECTS\\Motor_classification\\trans_Xexp.pkl"
